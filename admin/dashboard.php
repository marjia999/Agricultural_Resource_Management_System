...
<head>
    ...
    <style>
        * {
        ...
        .status-available, .status-approved, .status-paid, .status-returned {
            background: #d4edda;
            color: #155724;
        }
        ...
        .status-rented, .status-approved, .status-processing {
            background: #cce5ff;
            color: #004085;
        }

        .status-under_maintenance, .status-cancelled, .status-failed {
            background: #f8d7da;
            color: #721c24;
        }
